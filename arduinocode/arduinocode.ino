...
// yogurt variables
double SanitizeTemp = 185;
double StarterHoldTemp = 110;
double IncubTemp = 100;
double IncubDuration = 10*3600;
...
void yogurt(){
  switch(YogStep){
    ...
    case 2:
      ...
      Temperature = measuretemp();
      if (Temperature <= StarterHoldTemp){
        YogStep++;
        lcd.clear();
